...
function randomizeQuote(){
    var num = Math.floor(Math.random() * 34);
    ...
    if(num==0){
        ...
        quote.innerHTML = "I like that boulder! That is a nice boulder!";
        author.innerHTML = "-Donkey";
    }
    else if (num == 23){
        quote.innerHTML = "I have a bad feeling about this.";
        author.innerHTML = "-Obi Wan Kenobi";
    }
    else if (num == 24){
        quote.innerHTML = "Master Skywalker, there are too many of them, what are we going to do?";
        author.innerHTML = "-a youngling";
    }
    else if (num == 25){
        quote.innerHTML = "I am the Senate!";
        author.innerHTML = "-Sheev Palpatine";
    }
    else if (num == 26){
        quote.innerHTML = "The ability to speak does not make you intelligent.";
        author.innerHTML = "-Qui Gon Jinn";
    }
    else if (num == 27){
        quote.innerHTML = "Cows are our friends, Lana....They might even be our best friends.";
        author.innerHTML = "-Stirling Archer";
    }
    else if (num == 28){
        quote.innerHTML = "Are those fricken' sharks with fricken' laser beams attached to their fricken' heads?";
        author.innerHTML = "-Dr Evil";
    }
    else if (num == 29){
        quote.innerHTML = "Oh, king eh? Very nice. And how'd you get that, eh? By exploiting the workers. By hanging on to outdated imperialist dogma which perpetuates the economic and social differences in our society.";
        author.innerHTML = "-Dennis";
    }
    else if (num == 30){
        quote.innerHTML = "The Black Knight always triumphs!";
        author.innerHTML = "-The Black Knight";
    }
    else if (num == 31){
        quote.innerHTML = "Please! This is supposed to be a happy occasion. Let's not bicker and argue over who killed who.";
        author.innerHTML = "-King of Swamp Castle";
    }
    else if (num == 32){
        quote.innerHTML = "Mama always said life was like a box of chocolates: You never know what you're gonna get.";
        author.innerHTML = "-Forrest Gump";
    }
    else if (num == 33){
        quote.innerHTML = "I was hiding under your porch because I love you.";
        author.innerHTML = "-Dug";
    }
    else if (num == 34){
        quote.innerHTML = "What is this? A center for ants?";
        author.innerHTML = "-Derek Zoolander";
    }
}
    ...
    if(user) {
        database.ref("user themes/" + user.uid).on('value', function(snapshot){
            ...
            if(theme == "campfire"){
                ...
                document.getElementById("account-warning").className = "brown-text darken-4 center-align";
                document.getElementById("nav-wrapper").className =  "nav-wrapper grey darken-4";
                document.getElementById("logo").className = "brand-logo blue-text";
                var cards = document.querySelectorAll(".card");
                for(var i =0; i< cards.length;i++){
                    cards[i].className = "card grey darken-1 brown-text darken-4";
                }
                var buttons = document.querySelectorAll(".btn");
                for(var i=0;i<buttons.length;i++){
                    if(!buttons[i].className.includes('no-modal')){
                ...
                var dropdowns = document.querySelectorAll(".dropdown-content");
                for(var i=0;i<dropdowns.length;i++){
                    dropdowns[i].className= "dropdown-content brown-text darken-1";
                }
            }
            else if(theme == "aqua"){
                ...
                var dropdowns = document.querySelectorAll(".dropdown-content");
                for(var i=0;i<dropdowns.length;i++){
                    dropdowns[i].className= "dropdown-content white-text";
                }
            }            
            else if(theme == "mocha"){
                document.body.className = "brown darken-4";
                document.getElementById("account-warning").className = "white-text center-align";
